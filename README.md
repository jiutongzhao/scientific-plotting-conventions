...
*(The **[per-publisher layouts](#page-layouts-by-publisher)** near the top of this README show these specs drawn to scale — one page per journal. They are generated by [`publisher_page_layouts.py`](publisher_page_layouts.py) using the column widths (§11.4), panel-label styles (§11.5) and editable vector export (§5) covered in this document.)*
